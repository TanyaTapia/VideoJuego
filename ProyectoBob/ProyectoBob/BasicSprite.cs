...
namespace ProyectoBob
{
    ...
    class BasicSprite
    {
       //Atributos
        ...
        Vector2 increment; //Incremento para el movimiento automatico
        bool move;          //booleano para asiganarel movimiento automatico

        //metodos

        //metodo para asignar el incremento al movimiento automatico
        ...
        //metodo para asignar el movimiento automatico
